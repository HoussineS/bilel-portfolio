...
const translations = {
  en: {
    ...
    "contact.subtitle": "I'm available for professional work opportunities internationally. Don't hesitate to reach out!",
    "contact.phone.label": "Call Me",
    "contact.phone.value": "+216 93 199 930",
    "contact.whatsapp.label": "WhatsApp",
    "contact.whatsapp.value": "+216 93 199 930",
    "contact.email.label": "Email",
    "contact.email.value": "bileljmal0@icloud.com",
    "contact.location.label": "Location",
    "contact.location.value": "Sfax, Tunisia — Open to international opportunities",
  ...
  ar: {
    ...
    "contact.subtitle": "أنا متاح لفرص العمل الاحترافية في الخارج. لا تتردد في التواصل!",
    ...
    "contact.location.value": "صفاقس، تونس — منفتح على فرص العمل الدولية",
